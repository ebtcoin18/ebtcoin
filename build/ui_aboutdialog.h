...
"Copyright &copy; 2011-YYYY The EBTCoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About EBTCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>EBTCoin</b> version", 0));
